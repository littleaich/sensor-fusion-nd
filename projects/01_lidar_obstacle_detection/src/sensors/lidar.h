...
struct Lidar
{
		...
		: cloud(new pcl::PointCloud<pcl::PointXYZ>()), position(0,0,2.6)
	{
		...
		double horizontalAngleInc = pi/64; // pi/6 original
	...
	// this function does ray casting 
	// render your lidar rays as line segments in the viewer
	// you can visualize the rays with function renderRays() in render.cpp
